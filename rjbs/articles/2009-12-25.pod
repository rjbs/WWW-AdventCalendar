...
...and get some nicely colorized Lisp code.  That uses L<Vim|Text::VimColor>
(the editor) to colorize my code, but for Perl I decided to use L<PPI::HTML>,
which was faster and had a bit more control.  I could just write L<=begin perl>
