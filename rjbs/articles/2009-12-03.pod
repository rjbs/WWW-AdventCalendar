...
least half of them a I<pipemailers>.  A pipemailer reads a message on STDIN and
exits with a code that lets the calling program know what happened.  To grossly
simplify, the possible exit values are:

=for wikidoc
* {0E<nbsp>} - everything is okay; the message has been handled
...
L<Mail::Audit> or some other Perl library for deliverying your mail.  I mean,
...
* [Email::Filter]
* [Mail::Audit]
* [Perrin Harkins speaks for us all|http://use.perl.org/~perrin/journal/36161]
