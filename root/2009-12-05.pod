...
come with the growing resurgence of L<SDL
Perl|git://github.com/kthakore/SDL_perl.git>.  Pretty soon, dozens of graphical
bowling games written in Perl will be in the works, and they'll all be easier
to write thanks to Games::Bowling::Scorecard.  I look forward to the day when
the F<ELFBOWL2.EXE> that I angrily delete is compiled from Perl, using my own
code.
